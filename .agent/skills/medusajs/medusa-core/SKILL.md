...
- **medusa-admin:** Building admin UI (widgets, pages, forms)
- **medusa-storefront:** Calling backend API routes from storefronts (SDK integration)
...
2. **Frontend:** Load `medusa-admin` skill
3. **Connection:**
...
**For Storefronts:**
1. **Backend (this skill):** Module → Workflow → API Route
2. **Frontend:** Load `medusa-storefront` skill
3. **Connection:**
