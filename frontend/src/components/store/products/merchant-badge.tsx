...
export function MerchantBadge({ onOpenDrawer }: MerchantBadgeProps) {
  return (
    <button
      ...
      className="inline-flex items-center gap-1 text-[10px] font-bold uppercase tracking-wider text-emerald-700 bg-emerald-100/70 hover:bg-emerald-100 border border-emerald-200/80 px-2 py-0.5 rounded transition-all cursor-pointer select-none dark:bg-emerald-950/40 dark:text-emerald-400 dark:border-emerald-900/30 dark:hover:bg-emerald-950/60"
