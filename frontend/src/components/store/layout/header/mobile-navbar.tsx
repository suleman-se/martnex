...
export function MobileNavbar({
  ...
  return (
    <div className="fixed bottom-0 left-0 right-0 z-50 bg-white/95 backdrop-blur-md border-t border-slate-100 h-16 flex lg:hidden items-center justify-around px-4 shadow-premium pb-safe">
      {/* Shop/Home */}
      <Link
        href="/store"
      ...
      >
        ...
        {itemCount > 0 && (
          <span className="absolute -top-0.5 right-1 h-3.5 w-3.5 rounded-full bg-slate-900 text-white text-[9px] font-black flex items-center justify-center animate-in zoom-in duration-200">
