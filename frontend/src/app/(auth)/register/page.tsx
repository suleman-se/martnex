...
export const metadata = {
  title: 'Sign Up - Martnex',
  description: 'Create your Martnex account and start selling or shopping.',
};
...
export default function RegisterPage() {
  return (
    <AuthContainer
      title="Register"
      description="Join Martnex marketplace today"
    >
      <RegisterForm />

      <div className="mt-8 pt-8 border-t border-border/10 flex flex-col items-center gap-6">
        <p className="text-[10px] text-muted-foreground font-black uppercase tracking-[0.2em] leading-tight text-center max-w-[280px]">
